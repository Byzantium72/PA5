...
if __name__ == '__main__':
    ...
    #Parameters - where you're sending it, interface?
    encap_tbl_D = {'H2': '9'}    # table used to encapsulate network packets into MPLS frames
    #12 here is what you send it out as, where you send it, and what interface you're using
    frwd_tbl_D = {'9': ['12', 'H2', 1] , '12':['9','H1',0]}     # table used to forward MPLS frames
    decap_tbl_D = {'9':'H1'}    # table used to decapsulate network packets from MPLS frames
