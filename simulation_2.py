...
if __name__ == '__main__':
    ...
    frwd_tbl_D = {'1': ['11', 'H1', 2], '2':['12','H2',3]} #, '3':['4','RB',0], '4':['5','RC',1]}     # table used to forward MPLS frames
    decap_tbl_D = {}#'99':'H3','98':'H2'}    # table used to decapsulate network packets from MPLS frames
    ...
    frwd_tbl_D = {'11': ['21', 'H1', 1]}# '7':['6','H1',1]}
    ...
    #Still need to be able to have source, to send to new route
    frwd_tbl_D = {'21': ['31', 'H1', 2], '22': ['32', 'H2', 2]}#'1': ['7', 'H1', 2], '2':['8','H2',1], '6':['97','H3',0]}     # table used to forward MPLS frames
