...
if __name__ == '__main__':
    ...
    frwd_tbl_D = {'1': ['11', 'H1', 2], '2':['12','H2',3], '98': ['99', 'H3', 1]} #, '3':['4','RB',0], '4':['5','RC',1]}     # table used to forward MPLS frames
    decap_tbl_D = {'99':'H3'}    # table used to decapsulate network packets from MPLS frames
    ...
    frwd_tbl_D = {'11': ['21', 'H1', 1], '97': ['98', 'H3', 0]}# '7':['6','H1',1]}
    ...
    encap_tbl_D = {}
    frwd_tbl_D = {'12': ['22', 'H2', 1]}#,'6':['8','H2',0]}
    decap_tbl_D = {}
    ...
    #create routers and routing tables for connected clients (subnets)
    encap_tbl_D = {'H3': '96'}#'H1': '1','H2': '2'}    # table used to encapsulate network packets into MPLS frames
    #Still need to be able to have source, to send to new route
    frwd_tbl_D = {'21': ['31', 'H1', 2], '22': ['32', 'H2', 2], '96': ['97', 'H3', 0]}#'1': ['7', 'H1', 2], '2':['8','H2',1], '6':['97','H3',0]}     # table used to forward MPLS frames
    decap_tbl_D = {'31':'H1', '32':'H2'}    # table used to decapsulate network packets from MPLS frames
    ...
    host_1.udt_send('H1', 'MESSAGE_%d_FROM_H1' % 0, 0)
    #host_1.udt_send('H3', 'MESSAGE_%d_FROM_H1' % 1, 1)
    host_2.udt_send('H2', 'MESSAGE_%d_FROM_H2' % 0, 0)
    host_3.udt_send('H3', 'MESSAGE_%d_FROM_H3' % 0, 1)

    #create some send events    
    for i in range(3):
        priority = i%2
        host_1.udt_send('H1', 'MESSAGE_%d_FROM_H1' % i, priority)

    for i in range(3):
        priority = i%2
        host_2.udt_send('H2', 'MESSAGE_%d_FROM_H2' % i, priority)

    for i in range(3):
        priority = i%2
        host_3.udt_send('H3', 'MESSAGE_%d_FROM_H3' % i, priority)
